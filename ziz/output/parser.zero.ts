...
// @zero on (string out$) <- main (string args$)
...
// @zero on (int depth$) <- bracket depth of matching (char c$) (string pair)
...
// @zero on (string result$) <- test brackets
...
// @zero on (int pos) = matching (string pair) in (string s) after (int start)
