...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "b74fd1cbd3ecbf31", "git": "63694d42e9e5", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
