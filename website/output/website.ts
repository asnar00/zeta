...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "51a71f6e07e3e356", "git": "8b14cda72df3", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
