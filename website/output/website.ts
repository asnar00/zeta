...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "df1270ac14b883fc", "git": "a02fdd946fc1", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
