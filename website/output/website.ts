...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "f2a6268c7868a3f7", "git": "4ecf811c5ef0", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
