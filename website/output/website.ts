...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "9da3e198b1904730", "git": "79566cab8267", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
