...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "b689bc25f8df8e7f", "git": "5c814bba555a", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
