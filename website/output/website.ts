...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "5efe25bf7dfd7900", "git": "f09a8bfd5940", "features": "website,not-found,login,rpc,landing-page,background,blackbox,test-blackbox,test-replay"};
