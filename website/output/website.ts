...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "0664eaaaf6c7ed46", "git": "525788bd46a2", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
