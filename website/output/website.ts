...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "749d0d80103830e1", "git": "d3be8baff7b6", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
