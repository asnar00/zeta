...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "6caf3071d94863c8", "git": "2bd46a787713", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
