...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "cc99c25cff2e5caa", "git": "6a306a54223d", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
