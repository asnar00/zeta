...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "96ed6614c2adb405", "git": "9a0d27ccfdf2", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
