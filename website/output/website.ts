...
const _BUILD_FINGERPRINT: {hash: string, git: string, features: string} = {"hash": "8127acd6144f38cc", "git": "c5501bfc2e93", "features": "website,not-found,login,rpc,landing-page,background,test-blackbox"};
