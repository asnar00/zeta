...
function _subscribe_to_input(callback: (call: any) => void): void {
...
function _instrument_input(fn_name: string, _fn: Function): void {
    _input_instrumented.add(fn_name);
}

function _record_input(fn_name: string, args: string, result: any): any {
